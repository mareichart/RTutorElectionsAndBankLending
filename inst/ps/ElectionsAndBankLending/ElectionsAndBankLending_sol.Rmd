...
The problem set is published on the following websites: ####links aktualisieren####
- `Github`: https://github.com/skranz/RTutor
- `Shinyapps`: https://markusreichart.shinyapps.io/RTutorExample/
...
```
#< quiz "distribution"
question: How would you describe the distribution of Bank_Loans based on this histogram?
sc:
    - skewed to the left
    - symmetric
    - skewed to the right*
...
Then, the variance of $\beta$ is given by:
