...
Quiz: How would you describe the distribution of BankLoans based on this histogram?
...
Quiz: Based on `plot1`, what causal effect of elections on savings bank lending would you expect?
...
```{r eval=FALSE}
# Run line to answer the quiz above
answer.quiz("causal effect plot1")
```
...
Quiz: What does the coefficient $\beta_0$ measure?
...
Quiz: What does the coefficient $\beta_1$ measure?
...
Quiz: What does the coefficient $\beta_2$ measure?
...
Quiz: What do you think? Is election-induced lending higher or lower for close elections compared to elections in general?
